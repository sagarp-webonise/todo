...
type GooseDbVersionCrudService interface {
...
type GooseDbVersionCrudServiceImpl struct {
...
type GooseDbVersionIndexualService interface{

	GooseDbVersionByID(db XODB, id int) (*GooseDbVersion, error)
}
